...
/**
 * check_chain_condition - checks we should continue chaining based on last status
 * @info: the parameter struct
 * @buf: the char buffer
 * @p: address of current position in buf
...
/**
 * replace_alaiases - replaces an aliases in the tokenized string
 * @info: the parameter struct
 *
 * Return: 1 if replaced, 0 otherwise
 */
int replace_alaiases(info_t *info)
{
	int i;
	list_t *node;
	char *p;
